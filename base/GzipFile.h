...
//
#pragma once
#ifndef SALANGANE_GZIPFILE_H
#define SALANGANE_GZIPFILE_H
...
namespace salangane {
    ...
    public :
        ...
        offt_t offset() const {return ::gzoffset(file_);}
#endif
    ...
    // int flush(int f) {return ::gzflush(file_, f);}
        ...
        static GzipFile openWriteTruncate(StringArg filename) {
