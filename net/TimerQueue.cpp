...
namespace salangane {
    namespace net {
        namespace detail {
            ...
            //第二个可以传递控制标志：TFD_NONBLOCK（非阻塞），TFD_CLOEXEC（同O_CLOEXEC）
            int createTimerfd() {
...
using namespace salangane::net::detail;
      ...
      callingExpiredTimers_(false)
{
    ...
    // we are alwas reading the timerfd, we disarm it wih timerfd_settime,
...
TimerQueue::~TimerQueue() {
    ...
    ::close(timerfd_);
    // do not remove channel , since we are in EventLoo::dtor()
